  ...
  return (
    <section className={`panel details-panel ${incident.type.toLowerCase()}`} aria-labelledby="details-heading">
      ...
      <div className="details-body">
        ...
        <dl className="detail-facts"><div><dt>Reported</dt><dd>{incident.reported}</dd></div><div><dt>Source</dt><dd>Access Point {incident.node}</dd></div><div><dt>Location</dt><dd>{incident.location}</dd></div></dl>
